...
class PurchaseOrderController extends Controller
{
    ...
    {
        $query = PurchaseOrder::with(['supplier', 'serviceRequest'])->orderByDesc('po_id');
    ...
    public function store(Request $request)
    {
        ...
        return DB::transaction(function () use ($data) {
            ...
            return redirect()->route('purchase-orders.show', $po->po_id)->with('success', 'PO created and submitted for approval.');
        });
    }
    ...
    public function approve(PurchaseOrder $purchase_order)
    {
        ...
        return DB::transaction(function () use ($purchase_order) {
            ...
            ActivityLog::create([
                ...
                'context_id' => $purchase_order->po_id,
